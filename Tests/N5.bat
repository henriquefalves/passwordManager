...
start cmd /k mvn exec:java "-Dexec.args=8010 3"
timeout /t 5
cd ../Client
call mvn clean compile
start cmd /k mvn -Dtest=ClientIndependetTests#TestN -DargLine="-Dfaults=1 -DnumberClients=1 -DnumberServers=5"  test
