...
public class ClientApplication {
	...
	private static void automated(Client client, KeyStore ks) throws RemoteException {
		...
		savePassword(client, "twitter.com", "henrique@hotmail.com", "654321");
		receivedPassword = retrievePassword(client, "twitter.com", "henrique@hotmail.com");
		System.out.println("(expected=654321) Result Get: " + new String(receivedPassword, StandardCharsets.UTF_8));

		receivedPassword = retrievePassword(client, "invalid-domain", "invalid-username");
