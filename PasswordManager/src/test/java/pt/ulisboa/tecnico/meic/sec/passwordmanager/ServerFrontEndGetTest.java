...
public class ServerFrontEndGetTest extends ServerFrontEndTest {
    ...
    public void getSuccessTest() throws RemoteException {
        ...
        // put
        Message insecureMessagePut = new Message(resultChall.challenge,HASHKEY, PASSWORD);
        ...
        // get
        Message insecureMessage = new Message(resultChall2.challenge, HASHKEY, null);
    ...
    public void getWrongPublicKeyOfSenderTest() throws RemoteException {
        Message insecureMessage = new Message(challenge, HASHKEY, null);
        Message secureMessage = Crypto.getSecureMessage(insecureMessage, sessionKey, clientPrivate, clientPublic, serverPublic);
    ...
    public void getInvalidChallengeTest() throws RemoteException {
        ...
        Message insecureMessage = new Message(invalidChallenge, HASHKEY, null);
        Message secureMessage = Crypto.getSecureMessage(insecureMessage, sessionKey, clientPrivate, clientPublic, serverPublic);
        serverFE.get(secureMessage);
    }
    ...
    @Test(expected = CorruptedMessageException.class)
    public void getWrongHashkeyNotBlockSizeTest() throws RemoteException {
        Message insecureMessage = new Message(challenge, HASHKEY, null);
        Message secureMessage = Crypto.getSecureMessage(insecureMessage, sessionKey, clientPrivate, clientPublic, serverPublic);
    ...
    @Test(expected = CorruptedMessageException.class)
    public void getWrongHashkeyBlockSizeTest() throws RemoteException {
        Message insecureMessage = new Message(challenge, HASHKEY, null);
        Message secureMessage = Crypto.getSecureMessage(insecureMessage, sessionKey, clientPrivate, clientPublic, serverPublic);
    ...
    @Test(expected = CorruptedMessageException.class)
    public void getWrongHashkeyBlockSizeCipheredTest() throws RemoteException {
        Message insecureMessage = new Message(challenge, HASHKEY, null);
        Message secureMessage = Crypto.getSecureMessage(insecureMessage, sessionKey, clientPrivate, clientPublic, serverPublic);
    ...
    @Test(expected = CorruptedMessageException.class)
    public void getNullHashkeyTest() throws RemoteException {
        Message insecureMessage = new Message(challenge, HASHKEY, null);
        Message secureMessage = Crypto.getSecureMessage(insecureMessage, sessionKey, clientPrivate, clientPublic, serverPublic);
